...
class MainActivityTest {
    ...
    fun initValidString() {
        ...
        myScoreButton = com.example.assignment1.R.id.plus
        myStealButton = com.example.assignment1.R.id.minus
        myResetButton = com.example.assignment1.R.id.reset
        myScoreTextField = com.example.assignment1.R.id.answer
    }
